module.exports = {
  ...
  normal: [
    ...
    [
      ...
      { value: "Alt", type: "alt", x: 2 },
      { type: "empty" },
    ],
    [
      { value: "Cancel", type: "cancel", x: 2 },
      { type: "empty" },
      { value: " ", type: "standard", x: 5 },
      { type: "empty" },
      { type: "empty" },
      { type: "empty" },
      { type: "empty" },
